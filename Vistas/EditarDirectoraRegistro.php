  ...
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
    ...
    <div class="col-4 container-fluid text-center" id="navbarSupportedContent">
	  ...
	  <div class="pt-0 mt-0">
		...
		<h5 class="col-12 text-center pb-0">Editar Reporte</h5>  
        </li>
      </div>
...
<div id="formulario" class="container border border-dark p-3 pt-4 rounded-2 bg-light">
    ...
    <form method="POST" class="row g-3" action ="../Controlador/ReporteDocenteContoller.php">
        ...
        <div class="form-group col-12">
           ...
           placeholder="Ingrese el nombre del reporte" value="<?php echo $reporte['NombreReporte']; ?>">
        </div>
        

        <div class="form-group col-12">
            <label for="DetalleReporte">Detalle Reporte</label>
            <input type="text" class="form-control" id="DetalleReporte" name="DetalleReporte" placeholder="Ingrese el detalle del reporte" value="<?php echo $reporte['DetalleReporte']; ?>">
        </div>


        <div class="form-group col-12">
            <label for="Derivar">Derivar</label>
            <select class="form-select" id="Derivar" name="Derivar" aria-label="Derivar el incidente">
                <option value="Derivar incidente"<?php if ($reporte['Derivar'] === 'Seleccione un nivel de urgencia') echo ' selected'; ?>>Seleccione un nivel de urgencia</option>
        ...
        <div class="form-group col-12">
            ...
            <select class="form-select" id="Estado" name="Estado" aria-label="Estado del incidente / reporte">
        ...
        <!-- <button type="submit" name="EditarReporte" class="btn btn-primary">EditarReporte</button> -->

        <div class="col-12 btn w-100">
            <button type="submit" name="EditarReporte" class="btn btn-primary border-dark border-2 btn w-50" id="btnInicio">Editar reporte</button>
