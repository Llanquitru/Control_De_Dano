  ...
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
    ...
    <div class="col-4 container-fluid text-center" id="navbarSupportedContent">
	  ...
	  <div class="pt-0 mt-0">
		...
		<h5 class="col-12 text-center pb-0">Mostrar Incidente</h5>
...
<?php
// Recupera el ID del incidente de la URL.
...
?>
    ...
    <form method="POST" class="Formulario row g-3 border border-dark rounded-2" action ="../Controlador/IncidenteDocenteController.php">
    ...
    <input type="text" class="form-control" id="NombreIncidente" name="NombreIncidente" 
           placeholder="Ingrese el nombre del incidente" value="<?php echo $incidente['NombreIncidente']; ?> " readonly>
</div>
    ...
    <input type="text" class="form-control" id="NombreAsignatura" name="NombreAsignatura" 
           placeholder="Ingrese la asignatura" value="<?php echo $incidente['NombreAsignatura']; ?>" readonly>
        </div>


        <div class="form-group">
            <label for="Seccion">Seccion</label>
            <input type="text" class="form-control" id="Seccion" name="Seccion" placeholder="Ingrese la seccion de la asignatura" value="<?php echo $incidente['Seccion']; ?>" readonly>
        </div>
    ...
    <select class="form-select" id="Urgencia" name="Urgencia" aria-label="Seleccione un nivel de urgencia" disabled>
    ...
    <select class="form-select" id="TipoIncidente" name="TipoIncidente" aria-label="Ingrese el INCIDENTE" disabled>
        ...
        <div class="form-group">
            ...
            <select class="form-select" id="Laboratorio" name="Laboratorio" aria-label="Ingrese el laboratorio" disabled>
        ...
        <div class="form-group">
            ...
            <select class="form-select" id="Salon" name="Salon" aria-label="Salon" disabled>
    ...
    <textarea class="form-control" id="DetalleIncidente" name="DetalleIncidente" rows="3" readonly><?php echo $incidente['DetalleIncidente']; ?></textarea>
</div>

<div class="form-group">
    <label for="Solucion">Propuesta de solucion</label>
    <textarea class="form-control" id="Solucion" name="Solucion" rows="3" readonly><?php echo $incidente['Solucion']; ?></textarea>
</div>
